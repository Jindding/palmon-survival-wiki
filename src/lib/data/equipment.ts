...
export const equipmentGuide: EquipmentSection[] = [
  {
    ...
    bullets: [
      "핵심 캐릭터 (팀 메인 딜러 신화 팰몬) 한 마리의 장비 레벨을 다른 팰몬보다 +20 높게 유지하며 레벨업.",
  ...
  },
  {
    ...
    bullets: [
      "1순위: 신화 팰몬 & 에스카피에 (에스카피에 조합은 신화 팰몬과 함께 반드시 방어 장비 승급)",
  ...
  },
  {
    ...
    emoji: "💡",
    bullets: [
      "장비 하나에 몰아주지 말고, 한 캐릭터의 4개 장비를 다 같이 2성 → 5성 → 7성 순으로 골고루 올릴 것.",
