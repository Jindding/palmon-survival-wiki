...
import {
  ...
  season2Meta,
  type SubBlock,
} from "@/lib/data/season2";

export const metadata: Metadata = {
  title: "시즌 2 가이드",
  description: `${season2Meta.season} '${season2Meta.seasonName}' 시즌 2 시스템·이벤트·전략 가이드`,
};
...
export default function Season2Page() {
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <PageHeader
        emoji="🏜️"
        title={`${season2Meta.season}: ${season2Hero.name}`}
        description={season2Hero.tagline}
        meta={<>최종 업데이트: {season2Meta.updatedAt}</>}
      />
